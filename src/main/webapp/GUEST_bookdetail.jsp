            ...
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    ...
                    <div class="col-md-6">
                        ...
                        <h1 class="display-5 fw-bolder"><%= sach.getTenSach() %></h1>
						...
						<% } else { %>
						<div class="fs-5 mb-5"><span class="text-decoration-line-through"><%= sach.getGiaBan()%></span><%= sach.getGiaUuDai()%></div>
						<% } %>
                        
                        
                        
                        <p class="lead"><%= sach.getMoTa() %></p>
                        <div class="d-flex">
                            <input class=" form-control text-center me-3" id="inputQuantity" type="number" value="1" style="max-width: 3rem;style=max-width: 3rem;max-height: 3rem;margin-bottom: 0px;margin-top:1rem" />
                            <button class="btn btn-outline-dark flex-shrink-0" type="button" style="max-height: 3rem" data-bs-target="#login_ModalToggle" data-bs-toggle="modal">
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="product-item">
									...
									<figcaption>
										<h3><a href="CONTROLLER_GUEST?modget=view&masach=<%= listBookRelated.get(i).getMaSach()%>"><%= listBookRelated.get(i).getTenSach()%></a></h3>
