...
<body data-bs-spy="scroll" data-bs-target="#header" tabindex="0">
	<%
        ...
        ArrayList<SACH> listBookRelated = (ArrayList<SACH>) request.getAttribute("listBookRelated");
 ...
 <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    ...
                    <div class="col-md-6"><img src="image_book/<%= sach.getTenAnh()%>" alt="book" class="single-image" style="width: 400px; height: 550px;"></div>
                    <div class="col-md-6">
                        
                        <h2 class="display-6 fw-bolder"><%= sach.getTenSach() %></h2>
                        
                        <% if(sach.getGiamGia() != 0) { %>
						<div><span><b>Sale off <%= sach.getGiamGia()%>%</b></span></div>
						<% } %>
						
						<% if(sach.getGiaUuDai() == sach.getGiaBan()) {%>
						<div class="fs-5 mb-5"><%= sach.getGiaBan()%></div>
						<% } else { %>
						<div class="fs-5 mb-5 "><span class="text-decoration-line-through"><%= sach.getGiaBan()%></span>&nbsp&nbsp&nbsp&nbsp&nbsp<%= sach.getGiaUuDai()%></div>
	...
	<% 
                        ...
                        <div class="d-flex">
                        	<form action="CONTROLLER_USER?modpost=dathang&masach=<%= sach.getMaSach() %>" method="post"  style="display: flex;">
                        		<input name="soluong" class=" form-control text-center me-3" id="inputQuantity" type="number" value="1" style="max-width: 3rem;style=max-width: 3rem;max-height: 3rem;margin-bottom: 0px;margin-top:1rem" />
	                            <button class="btn btn-outline-dark flex-shrink-0" type="submit" style="max-height: 3rem" >
...
<section id="related-books" class="py-5 my-5">
		<div class="container">
				...
				<div class="col-md-12">
					...
					<div class="product-list" data-aos="fade-up">
						<div class="row">
							...
							<% for(int i = 0; i < listBookRelated.size(); i++) { %>

							<div class="col-md-3">
								<div class="product-item">
									<figure class="product-style">
										<img src="image_book/<%= listBookRelated.get(i).getTenAnh()%>" alt="Books" class="product-item" style="width: 344px; height: 418px;">
										<button type="button" class="add-to-cart" data-product-tile="add-to-cart" >Add to
											Cart</button>
									</figure>
									<figcaption>
										<h3><a href="CONTROLLER_USER?modget=view&masach=<%= listBookRelated.get(i).getMaSach()%>"><%= listBookRelated.get(i).getTenSach()%></a></h3>
										<span><%= listBookRelated.get(i).getTacGia() %></span>
										<div class="item-price"><%= listBookRelated.get(i).getGiaBan() %></div>
									</figcaption>
								</div>
							</div>
							<% } %>
