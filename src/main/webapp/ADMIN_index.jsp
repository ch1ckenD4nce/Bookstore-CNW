					...
					<div class="row">
						...
						<div class="col-md-2">
							<div class="main-logo">
								...
								<a href="CONTROLLER_ADMIN?modget=home"><img src="images/logo.png" alt="logo"></a>
							</div>
												...
												<select class ="ccb-timkiem" id="ccb-timkiem" onchange="updateAndSubmit('ccb-timkiem', 'ccb-timkiem', 'cbb')">
													...
													<% for (int i = 0; i < listTheloai.size(); i++) { %>
									                	<option class="btn-wrap" value="<%= listTheloai.get(i).getIdtheloai() %>" 
												            <% if (listTheloai.get(i).getIdtheloai() == idtheloai) { %>
												                selected
												            <% } %>
												        >
    ...
    <div class="modal-content border-0 ">
      ...
      <form action="CONTROLLER_ADMIN?modpost=themsach" method="post" enctype="multipart/form-data">
        <div class="form-group mb-4">
	        ...
	        <input type="text" name="masach_update" id="masach_update" class="form-control" value="" style="height: 45px;">
        </div>
        
        <div class="form-group mb-2">
          	<label for="tensach_update" class="sr-only">TÊN SÁCH</label>
        	<input type="text" name="tensach_update" id="tensach_update" class="form-control" value="" style="height: 45px;">
        </div>
        
         <div class="form-group mb-2">
          	<label for="tacgia_update" class="sr-only">TÁC GIẢ</label>
        	<input type="text" name="tacgia_update" id="tacgia_update" class="form-control" value="" style="height: 45px;">
        </div>
        
         <div class="form-group mb-2">
          	<label for="nxb_update" class="sr-only">NXB</label>
        	<input type="text" name="nxb_update" id="nxb_update" class="form-control" value="" style="height: 45px;">
        </div>
         ...
         <div class="form-group mb-2">
        	...
        	<input type="text" name="giaban_update" id="giaban_update" class="form-control" value="" style="height: 45px;">
        </div>
        
         <div class="form-group mb-2">
          	<label for="giamgia_update" class="sr-only">GIẢM GIÁ</label>
        	<input type="text" name="giamgia_update" id="giamgia_update" class="form-control" value="" style="height: 45px;">
        </div>
        
         <div class="form-group mb-2">
          	<label for="mota_update" class="sr-only">MÔ TẢ</label>
        	<input type="text" name="mota_update" id="mota_update" class="form-control" value="" style="height: 45px;">
        </div>
        
         <div class="form-group mb-2">
          	<label for="fileanh_update" class="sr-only">ẢNH</label>
        	<input type="file" name="fileanh_update" id="fileanh_update" class="form-control" accept="image/*">
        </div>
